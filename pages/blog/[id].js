  ...
  return(
    <Layout >
      <Head>
        ...
        <link rel="canonical" href={`https://www.daytonlocalmusic.com/blog/${id}`} key="canonical"/>
      ...
      <article>
        ...
        <div className="w-full flex flex-row items-center justify-between">
          ...
          <div className="w-auto flex flex-row items-center justify-end">
            ...
            <a target="_blank" className="py-4" href={`https://twitter.com/intent/tweet?url=https://www.daytonlocalmusic.com/blog/${id}`}>
              <svg height="30" width="30" viewBox={"0 0 24 24"} fill={"#616161"}>
