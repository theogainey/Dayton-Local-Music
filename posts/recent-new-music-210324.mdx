...
<Image alt={`Nineteen Thirteen - MCMXIII`} src={`/images/nineteen-thirteen-mcmxiii.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Brother Hill - Blackfish`} src={`/images/brother-hill-blackfish.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Samuri West - Life Lessons`} src={`/images/samuri-west-life-lessons.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
