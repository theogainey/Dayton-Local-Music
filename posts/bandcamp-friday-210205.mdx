...
<Image alt={`The 1984 Draft/Gordon Withers`} src={`/images/1984-draft-honest.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
## Magnaphone Records
<Image alt={`Magnaphone Records`} src={`/images/magnaphone-records.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
