...
<Image alt={`Joey Beach - Horrible World`} src={`/images/joey-beach-horrible-world.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`The Katawicks - “This Dark Cloud”`} src={`/images/katawicks-dark-cloud.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
