...
<Image alt={`Andrew Gabbard - Instant Trancer`} src={`/images/andrew-gabbard-instant-trancer.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`This Pine Box Whatchy Got`} src={`/images/this-pine-box-whatchya-got.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
## Freight - *Neurocracy*
<Image alt={`Freight Neurocracy`} src={`/images/freight-neurocracy.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Boxcar Suite Every Side of the Abyss`} src={`/images/boxcar-suite-every-side-abyss.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
