...
<Image alt={`Heather Redman - “Everybody”`} src={`/images/heather-redman-everybody.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Mike Bankhead - Anxious Inventions & Fictions`} src={`/images/mike-bankhead-anxious-inventions.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Charlie & Amanda - The King & Queen of Dayton Country`} src={`/images/charlie-amanda-dayton-country.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
