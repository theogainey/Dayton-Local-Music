...
<Image alt={`Andrew Gabbard - Promises I've Made`} src={`/images/andrew-gabbard-promises-ive-made.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`K.Carter & TINO - Safe Money`} src={`/images/tino-kcarter-safe-money.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Mike Bankhead - Baile Conmigo`} src={`/images/mike-bankhead-baile-conmingo.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Poptek Records - Popilation Vol. 1`} src={`/images/poptek-records-popilation-vol1.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<YoutubeEmbed url={"https://www.youtube.com/embed/WTnuOB1FpYI"}/>
