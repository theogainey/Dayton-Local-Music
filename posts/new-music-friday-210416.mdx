...
<Image alt={`Alec Snead - Another Day`} src={`/images/alec-snead-another-day.png`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`M Ross Perkins - Bird Of The World`} src={`/images/m-ross-perkins-bird.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
## Nightbeast - *Actually*
<Image alt={`Nightbeast - Actually`} src={`/images/nightbeast-actually.png`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
