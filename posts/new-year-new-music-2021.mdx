...
<Image alt={`Andrew Gabbard - "Wake Up, Brother”`} src={`/images/andrew-gabbard-wake-up-brother.jpg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Weathervein - "Hurt Like Me"`} src={`/images/weathervein-hurt-like-me.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<YoutubeEmbed url={"https://www.youtube.com/embed/VS1_7vUyX_U"}/>
...
<YoutubeEmbed url={"https://www.youtube.com/embed/ltrucxcTNWo"}/>
