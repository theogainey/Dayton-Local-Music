...
<Image alt={`Seth Gilliam - Sweet Tea`} src={`/images/seth-gilliam-sweet-tea.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`Zeb McNabb - Three Screen Dream"`} src={`/images/zeb-mcnabb.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<Image alt={`This Pine Box - "Would You Walk"`} src={`/images/would-you-walk.jpeg`} lazy="true" layout="responsive" objectFit="contain" height={400} width={400}/>
...
<YoutubeEmbed url={"https://www.youtube.com/embed/8LhmDXeyuPU"}/>

While not a new song, who doesn't love a good new music video? In this case, [Nick Kizirnis](http://nickkizirnis.com/) released a music video on April 30th for his song ["After You're Gone"](https://youtu.be/8LhmDXeyuPU). In addition to being featured in the video, the song comes off his latest solo album *The Distance*. Also important to why we love this video is that it was edited by Brandon Berry of The Paint Splats.
